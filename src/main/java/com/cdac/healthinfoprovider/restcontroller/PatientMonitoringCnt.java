...
@RestController
@RequestMapping( value = "/v0.5") //RequestMethod.PUT, RequestMethod.POST,
public class PatientMonitoringCnt {
	...
	public ResponseEntity<?> postHeartbeat(@RequestBody PatientDiscoveryRequestFb patientDiscoveryRequestFb) {
		System.out.println("postHeartbeat:patientDiscoveryRequestFb::------------------------------------" + patientDiscoveryRequestFb);
		try {
