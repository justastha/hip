...
@RestController
@RequestMapping( value = "/v0.5/care-contexts") //RequestMethod.PUT, RequestMethod.POST,
public class PatientDiscoveryCnt {
	...
	public ResponseEntity<?> postDiscover(@RequestBody PatientDiscoveryRequestFb patientDiscoveryRequestFb) {
		System.out.println("postDiscovery:patientDiscoveryRequestFb::------------------------------------" + patientDiscoveryRequestFb);
		try {
